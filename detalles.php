...
if ($id == '' || $token == '') {
    ...
    if ($token == $token_tmp) {
        ...
        if ($sql->fetchColumn() > 0) {
            ...
            $sqlCaracter = $con->prepare("SELECT DISTINCT(det.id_caracteristica) AS idCat, cat.caracteristicas FROM  det_prod_caracter AS det INNER JOIN caracteristicas AS cat ON det.id_caracteristica=cat.id WHERE det.id_producto=?");
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 order-md-2">
                    ...
                    <div class="col-3 my-3">
                        Cantidad: <input clases="form-control" id="cantidad" name="cantidad" type="number" min="1" max="20" value="1">
                    </div>
